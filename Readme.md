...
5) Поместить все сервисы в один контекст, чтобы сократить количество кода. В будущем, если будут просадки от счётчиков Arc и Mutex 
можно будет просто запустить несколько процессов по процессу на каждое ядро. Или как то иначе это исправить. Но всё равно стоит измерить разницу.
